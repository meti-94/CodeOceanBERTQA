...
def combine_with_reverb(questions_path=r'../data/Final_Sheet_990824.xlsx',
	...
	# saving the outputs!
	dataframe.to_excel("../data/Intermediate/intermediate.xlsx")
...
def create_bertified_dataset( input_excel_dir = r'../data/Intermediate/',
							  output_pkl_dir = r'../data/Bertified/',
							  data_folder = r'data'):
	'''
...
def SQ_create_bertified_dataset(  input_excel_dir = r'../data/Intermediate/',
								  output_pkl_dir = r'../data/Bertified/',
								  data_folder = r'data'):
	'''
	This is where all the magics have happened. 
